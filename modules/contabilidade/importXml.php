<?php
    namespace Modulos\Contabilidade;
...
<html class="no-js" lang="pt-br">
    <head>
        <title>BID - Importação XML</title>
                        ...
                        <form method="post" action="post/importaDados.php" enctype="multipart/form-data">
                            <div class="widget widget-table">
                                <div class="widget-header">
                                    ...
                                    <h3 class="icon chart">Importação de arquivos XML</h3>
                                </div>
                        ...
                        <div class="widget widget-table">
                            ...
                            <div class="widget-content">
                                <table class="table table-bordered table-striped cadastroBID">
                                    ...
                                    <tbody>
                                        <?php echo "<tr><td>&#9679; $_SESSION[log]</td></tr>"; unset($_SESSION['log']); ?>
                                    </tbody>
                                </table>
                            </div>
                        </div>
