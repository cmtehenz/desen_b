...
<html class="no-js" lang="pt-br">
    <head>
        <title>BID - Contas a receber - Descontos</title>
    ...
    <body>
        <?php
            ...
            // Total cumulativo
            $dadosCumulativo = contasReceberDescontoAnoMes($ano, $mes);

            // Totais por cliente
            $dadosCliente = contasReceberSumClienteAnoMes('VLR_DESC', $ano, $mes);
            ...
            foreach ($dadosCliente as $key => $value){
                ...
                $linhaTabela .=
                    "<tr class='gradeA'>
                        <td><a href='fatura.php?mes=$mes&ano=$ano&cliente=$value[0]&opcao=descontos'>$value[1]</a></td>
                    ...
                    <div class="grid-24">
                        <div class="widget widget-table">
                            <div class="widget-header">
                                ...
                                <h3 class="icon chart">FATURA RECEBIMENTO - DESCONTOS</h3>
                            </div>
