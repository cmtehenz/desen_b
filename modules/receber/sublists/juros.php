...
<html class="no-js" lang="pt-br">
    <head>
        <title>BID - Contas a receber - Juros</title>
    ...
    <body>
        <?php
            ...
            // Total cumulativo
            $dadosCumulativo = contasReceberJurosAnoMes($ano, $mes);

            // Totais por cliente
            $dadosCliente = contasReceberSumClienteAnoMes('VLR_JUROS', $ano, $mes);
            ...
            foreach ($dadosCliente as $key => $value){
                ...
                $linhaTabela .=
                    "<tr class='gradeA'>
                        <td><a href='fatura.php?mes=$mes&ano=$ano&cliente=$value[0]&opcao=juros'>$value[1]</a></td>
                    ...
                    <div class="grid-24">
                        <div class="widget widget-table">
                            <div class="widget-header">
                                ...
                                <h3 class="icon chart">FATURA RECEBIMENTO - JUROS</h3>
                            </div>
