...
<html class="no-js" lang="pt-br">
    <head>
        <title>BID - Contas a receber - Vencido</title>
    ...
    <body>
        <?php
            ...
            // Total cumulativo
            $dadosCumulativo = contasReceberVencidoAnoMes($ano, $mes);

            // Totais por cliente
            $coluna = "VLR_PARCELA + VLR_JUROS - VLR_DESC";
            $filtro = " AND D.STATUS <> 'B' AND P.DATA_VENCTO < CURRENT DATE AND P.DATA_PAGTO IS NULL ";

            $dadosCliente = contasReceberSumClienteAnoMes('VLR_PARCELA', $ano, $mes, $filtro);
            ...
            foreach ($dadosCliente as $key => $value){
                ...
                $linhaTabela .=
                    "<tr class='gradeA'>
                        <td><a href='fatura.php?mes=$mes&ano=$ano&cliente=$value[0]&opcao=vencido'>$value[1]</a></td>
                    ...
                    <div class="grid-24">
                        <div class="widget widget-table">
                            <div class="widget-header">
                                ...
                                <h3 class="icon chart">FATURA RECEBIMENTO - VENCIDO</h3>
                            </div>
