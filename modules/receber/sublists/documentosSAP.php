...
<html class="no-js" lang="pt-br">
    ...
    <body>
        <?php
            ...
            if(isset($_GET['cnpjCliente'])){
                $cnpjCliente = $_GET['cnpjCliente'];
            }
            
            $i=0;
            foreach (listaDocumentos(null, $ano, $mes, $cnpjCliente, TRUE) as $dados) {
                $i++;
                $linhaTabela = $linhaTabela . "<tr class='gradeA'>
                                    ...
                                    <td align='right'>".number_format($dados[FRETEPESO], 2, ',', '.')."</td>
                                        <td align='right'>".number_format($dados[VALORCOMIMPOSTO], 2, ',', '.')."</td>
                                </tr>";
            }
                            ...
                            <div class="widget-content">
                                ...
                                <table class="table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        <tr class='gradeA'>
                                            <td><?php echo $i; ?></td>
                                            <td align="right"><?php echo number_format(totalDocumentosNFaturados($ano, $mes, null, $cnpjCliente), 2, ',', '.'); ?></td>
                                        </tr>
