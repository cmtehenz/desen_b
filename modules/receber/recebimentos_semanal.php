...
<html class="no-js" lang="pt-br">
    <head>
        <title>BID - Recebimentos semanal</title>
    ...
    <body>
        <?php
            ...
            for ($i = 0; $i < 7; $i++){
                ...
                $totalDia[$i] = contasReceberRecebimentosPeriodo($diasSemana[$i], NULL, 'recebido');
            }
            ...
            $sqlClientes = "SELECT
                ...
                WHERE
                    P.DATA_PAGTO BETWEEN '$diasSemana[0]' AND '$diasSemana[6]'
                    AND D.STATUS <> 'C'
            ...
            foreach ($listaClientes as $key => $cliente){
                ...
                for ($i = 0; $i < 7; $i++) $dia[$i] = contasReceberRecebimentosPeriodo($diasSemana[$i], NULL, 'recebido', $cliente[0]);
        ...
        <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="grid-24">
                        <form action="#" method="post" name="formRecebimentosSemanal">
                            <div class="field">
                                <label>Selecione a semana:</label>
                                <select name="selecao_semana" id="selecao_semana" onchange="document.formRecebimentosSemanal.submit()">
                        ...
                        <div class="widget widget-table">
                            <div class="widget-header">
                                ...
                                <h3 class="icon chart">RECEBIMENTOS SEMANAL</h3>
                            </div>
