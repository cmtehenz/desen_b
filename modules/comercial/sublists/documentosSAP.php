    ...
    <body>
        <?php
            ...
            if (isset($_GET['cliente'])){
                $cnpjCliente = $_GET['cliente'];
            }
            if (isset($_GET['filial'])){
                $filial = $_GET['filial'];
            }
            $totalFretePeso = 0;
            $totalFretePesoIcms = 0;
            
            foreach (listaDocumentos(null, $ano, $mes, $cnpjCliente, null, $filial) as $dados) {
                $linhaTabela = $linhaTabela . "<tr class='gradeA'>
                                    <td>$dados[TIPODOCTO]</td>
                                    <td>$dados[NOMEFILIAL]</td>
                                    <td>$dados[NUMERODOCTO]</td>
                                    <td>".date('d/m/Y', strtotime($dados[DATAEMISDOCTO]))."</td>
                                    <td>$dados[NOMECLIENTE]</td>    
                                    <td align='right'>".number_format($dados[FRETEPESO], 2, ',', '.')."</td>
                                    <td align='right'>".number_format($dados[FRETEPESOCICMS], 2, ',', '.')."</td>
                                </tr>";
                $totalFretePeso += $dados[FRETEPESO];
                $totalFretePesoIcms += $dados[FRETEPESOCICMS];
            }
                    ...
                    <div class="grid-24">
                        <div class="widget widget-table">
                            ...
                            <div class="widget-header">
                                ...
                                <h3 class="icon chart">Documentos</h3>
                            </div>
                                ...
                                <table class="table table-bordered table-striped ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>TOTAL FRETE PESO R$(ICMS)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class='gradeA'>
                                            <td><?php echo quantidadeDocumentos($placa, $ano, $mes) ?></td>
                                            <td align="right"><?php echo number_format($totalFretePeso, 2, ',', '.'); ?></td>
                                            <td align="right"><?php echo number_format($totalFretePesoIcms, 2, ',', '.'); ?></td>
                                        </tr>
