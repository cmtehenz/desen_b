...
<html class="no-js" lang="pt-br">
    ...
    <body>
        <?php
            ...
            $andamento  = $dbcDB2->qtdCargas($dtIni, $dtFin, "A");
                ...
                <div class="container">
                    <div class="grid-24">
                        <div class="widget widget-plain" style="text-align: center;">
                            ...
                            <div class="dashboard_report defaultState">
                                <div class="pad">
                                    <span class="value"><?php echo $finalizada; ?></span> Finalizada
                                </div> <!-- .pad -->
                            </div>
