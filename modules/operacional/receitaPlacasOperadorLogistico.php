        ...
        <?php
            ...
            foreach (listaReceitaPlacasOpeLog($operLog, $ano, $mes) as $dados) {
                $linhaTabela = $linhaTabela . "<tr class='gradeA'>
                                    ...
                                    <td>$dados[MOD]</td>
                                    <td>$dados[MOT]</td>
                                    <td align='right'><a href='sublists/documentos.php?placa=$dados[PL]&ano=$ano&mes=$mes'>".number_format($dados[FAT], 2, ',', '.')."</a></td>
                                </tr>";
                    ...
                    <div class="grid-24">
                        ...
                        <div class="widget widget-table">
                            ...
                            <div class="widget-header">
                                ...
                                <h3 class="icon chart">Receita Placas x Operador Logístico</h3>
                            </div>
                        ...
                        <div class="widget widget-table">
                            ...
                            <div class="widget-content">
                                ...
                                <table class="table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        <tr class='gradeA'>
                                            <td><?php echo quantidadePlacasOperadorLogistico($_POST['OpLog']); ?></td>
                                            <td align="right"><?php echo number_format(totalReceitaOpeLog($_POST['OpLog'], $ano, $mes), 2, ',', '.'); ?></td>
                                        </tr>
