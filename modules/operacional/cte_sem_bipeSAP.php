...
<html class="no-js" lang="pt-br">
    ...
    <body>
        <?php
            ...
            foreach (cteSemBipeFilial() as $dados){
                $linhaTabela = $linhaTabela . "<tr class='gradeA'>
                                    <td><a href='sublists/cte_sem_bipe_filialSAP.php?filial=$dados[IDFILIAL]'>$dados[FILIAL]</a></td>
                                    <td align='right'>$dados[QUANTIDADE]</td>
                                </tr>";
                

                //TITULOS PARA GRAFICO
                $titulo = $titulo . "<th>$dados[FILIAL]</th>";
                //VALORES PARA GRAFICO
                $graf_realizadoMes = $graf_realizadoMes . "<td>$dados[QUANTIDADE]</td>";
                
                $dadosTotalBipe += $dados[QUANTIDADE];
            }
        ?>
        <div id="wrapper">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <tr class="odd gradeX">
                                        ...
                                        <td align='right'><?php echo $dadosTotalBipe; ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div> <!-- .box -->
