...
<html class="no-js" lang="pt-br">
    <head>
        <title>BID - Contas a pagar - Desconto</title>
    ...
    <body>
        <?php
            ...
            // Total cumulativo
            $dadosCumulativo = contasPagarDescontoAnoMes($ano, $mes);

            // Totais por fornecedor
            $dadosFornecedor = contasPagarSumFornecedorAnoMes('DESCONTO', $ano, $mes);
            ...
            foreach ($dadosFornecedor as $key => $value){
                ...
                $linhaTabela .=
                    "<tr class='gradeA'>
                        <td><a href='nota.php?mes=$mes&ano=$ano&forneced=$value[0]&opcao=desconto'>$value[1]</a></td>
                    ...
                    <div class="grid-24">
                        <div class="widget widget-table">
                            <div class="widget-header">
                                ...
                                <h3 class="icon chart">CONTAS A PAGAR - DESCONTO</h3>
                            </div>
