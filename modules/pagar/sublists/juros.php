...
<html class="no-js" lang="pt-br">
    <head>
        <title>BID - Contas a pagar - Juros</title>
    ...
    <body>
        <?php
            ...
            // Total cumulativo
            $dadosCumulativo = contasPagarJurosAnoMes($ano, $mes);

            // Totais por fornecedor
            $dadosFornecedor = contasPagarSumFornecedorAnoMes('JUROS', $ano, $mes);
            ...
            foreach ($dadosFornecedor as $key => $value){
                ...
                $linhaTabela .=
                    "<tr class='gradeA'>
                        <td><a href='nota.php?mes=$mes&ano=$ano&forneced=$value[0]&opcao=juros'>$value[1]</a></td>
                    ...
                    <div class="grid-24">
                        <div class="widget widget-table">
                            <div class="widget-header">
                                ...
                                <h3 class="icon chart">CONTAS A PAGAR - JUROS</h3>
                            </div>
