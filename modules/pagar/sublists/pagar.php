...
<html class="no-js" lang="pt-br">
    ...
    <body>
        <?php
            ...
            // Total cumulativo
            $dadosCumulativo = contasPagarPagarAnoMes($ano, $mes);
            ...
            foreach ($dadosFornecedor as $key => $value){
                ...
                $linhaTabela .=
                    "<tr class='gradeA'>
                        <td><a href='nota.php?mes=$mes&ano=$ano&forneced=$value[0]&opcao=pagar'>$value[1]</a></td>
                    ...
                    <div class="grid-24">
                        <div class="widget widget-table">
                            <div class="widget-header">
                                ...
                                <h3 class="icon chart">CONTAS A PAGAR - PAGAR</h3>
                            </div>
