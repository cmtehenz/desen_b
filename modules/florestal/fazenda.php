    ...
    <body>
        <?php
            ...
            $sql_cliente = mssql_query("SELECT carregamento.idFazenda, sum(carregamento.peso), COUNT(*),(SELECT descricao FROM flr.fazenda WHERE idFazenda=carregamento.idFazenda) as origem
                                ...
                                GROUP BY carregamento.idFazenda
                                ORDER BY sum(carregamento.peso) DESC ");
            while ($dadosCliente = mssql_fetch_array($sql_cliente)){
                $peso = number_format($dadosCliente[1], 0, ',', '.');
                $linhaTabela = $linhaTabela . "<tr class='gradeA'>
                                    <td><a href='sublists/fazenda.php?origem=$dadosCliente[0]&mes=$mes_atual&ano=$ano'>$dadosCliente[3]</a></td>
                                    <td align='right'>$dadosCliente[2]</td>
                    ...
                    <div class="grid-24">
                        ...
                        <div class="widget widget-table">
                            ...
                            <div class="widget-header">
                                ...
                                <h3 class="icon chart">Faturamento Fazenda Florestal</h3>
                            </div>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-header">
                                ...
                                <h3 class="icon chart">PRODUCAO</h3>
                            </div>
