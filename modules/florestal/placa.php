...
<html class="no-js" lang="pt-br">
    <head>
        <title>BID - Análise por placa</title>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $("#ano").change(function(){ $("#frmAnalisePlaca").submit(); });
                $("#mes").change(function(){ $("#frmAnalisePlaca").submit(); });
            });
        </script>
    </head>
    <body>
        <?php
            ...
            $analise = $dbcSQL->analiseVeiculos($ano, $params);

            /** Escreve a tabela com base no novo array consolidado que possui os 12 meses */
            foreach ($analise as $veiculo){
                $idVeiculo   = $veiculo['idVeiculo'];
                $viagens     = $veiculo['viagens'];
                $peso        = $veiculo['peso'];
                $faturamento = $veiculo['faturamento'];
                
                $placa = $dbcDB2->placaVeiculo($idVeiculo);
                ...
                $linhaVeiculos .=
                    "<tr class='odd gradeX'>
                        <td><a href='./sublists/placa.php?idPlaca=$idVeiculo&placa=$placa'>$placa</a></td>
        ...
        <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="grid-24">
                        <form action="#" method="post" id="frmAnalisePlaca">
                            <div class="field">
                        ...
                        <div class="widget widget-table">
                            <div class="widget-header">
                                ...
                                <h3 class="icon chart">Análise de veículos</h3>
                            </div>
                            ...
                            <div class="widget-content">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody><?php echo $linhaVeiculos; ?></tbody>
                                </table>
                            </div> <!-- .widget-content -->
                        </div> <!-- .widget -->
