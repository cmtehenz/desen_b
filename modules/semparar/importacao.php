...
<html class="no-js" lang="pt-br">
    <head>
        <title>BID - Importação Sem Parar</title>
                        ...
                        <form method="post" action="post/importaDados.php" enctype="multipart/form-data">
                            <div class="widget widget-table">
                                <div class="widget-header">
                                    ...
                                    <h3 class="icon chart">Atualizar cadastros do Sem Parar</h3>
                                </div>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <td width="82%">
                                                    ...
                                                    &#9679; Nenhum arquivo é obrigatório, sendo assim você pode atualizar apenas as concessionárias por exemplo,
                                                    deixando os demais campos em branco. <br />
                                            ...
                                            <tr>
                                                <th colspan="2"><div align="center"><button class="btn btn-success">Importar</button></div></th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div> <!-- .widget-content -->
