    ...
    <body>
        <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="grid-24">
                        <form method="post" action="post/exportaFolha_sap_frota.php" enctype="multipart/form-data">
                                    ...
                                    <table class="table table-bordered table-striped cadastroBID">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td>  
                                                    <a href='post/exportaSapFrota.txt'>Clique Aqui para Baixar o Arquivo</a>													
						</td>
                                            </tr>
                                        </thead>
                                    </table>
