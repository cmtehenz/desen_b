    ...
    <body>
        <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="grid-24">
                        <form method="post" action="post/exportaBipe.php" enctype="multipart/form-data">
                            <div class="widget widget-table">
                                <div class="widget-header">
                                    <span class="icon-document-alt-stroke"></span>
                                    <h3 class="icon chart">Exportação de dados (Carta Frete) para a folha Questor</h3>
                                </div>
                                    ...
                                    <table class="table table-bordered table-striped cadastroBID">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td>  
													<a href='../post/bipe.txt'>Clique Aqui para Baixar o Arquivo</a>													
												</td>
                                            </tr>
                                        </thead>
                                    </table>
