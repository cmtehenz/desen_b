                    ...
                    <div class="grid-24">
                        ...
                        <div class="widget widget-table">
                            ...
                            <div class="widget-header">
                                ...
                                <h3 class="icon chart">Relação de Ocorrencias</h3>
                            </div>
                            ...
                            <div class="widget-content">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql_usuario = "SELECT * FROM ocorrencia ORDER BY descricao ASC";
                                            $script_usuario = mssql_query($sql_usuario);
                                            while ($linha = mssql_fetch_array($script_usuario)){
                                                echo"<tr class='odd gradeX'>
            <td align='left'>" . $linha['descricao'] . "</p></td>
            <td align='right'>" . $linha['pontos'] . "</p></td>
            </tr>";
                                            }
                                        ?>
                                    </tbody>
