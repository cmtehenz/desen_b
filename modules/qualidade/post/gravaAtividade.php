<?php
     ...
     */
    if ($params['id'] != null){
        $sql = "UPDATE atividades SET atividade = :atividade, data = CURRENT_TIMESTAMP WHERE id = :id";

        $msg = "Registro alterado com sucesso!";
    }
    else
    {
        $sql = "INSERT INTO atividades VALUES (:atividade, CURRENT_TIMESTAMP)";
